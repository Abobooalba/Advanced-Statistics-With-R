---
title: "Advanced Statistics HW5"
author:  "Due date: November 8, 2018"
output: pdf_document
---
...
$X$ is a random variable with finite $E(X-a)^2$, where $a$ is a scalar. Find $a$ such that $E(X-a)^2$ is minimized.
