---
title: "Advanced Statistics HW6"
author:  "Due date: November 13, 2018"
output: pdf_document
header-includes:
  - \usepackage{diagbox}
---
...
Assume the distribution of grades for a particular group of students has a bivariate normal distribution with parameters
$\mu_X=3.2$, $\sigma_X=0.4$, $\mu_Y=2.4$, $\sigma_Y=0.6$, and $\rho=0.6$, where $X$ and $Y$ represent the grade point averages in high school and the first year of college, respectively.
