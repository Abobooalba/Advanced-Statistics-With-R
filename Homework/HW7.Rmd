...
If $X \sim \chi^2(10)$, find the constants $a$ and $b$ such that $P(a<X<b)=0.90$ and $P(X<a)=0.05$.
...
(b) Graph the theoretical sampling distribution of $X$ when sampling from an $Exp(\lambda = 1)$ for $n$ = 30, 100, 300, and 500. Superimpose an appropriate normal density for each $\Gamma(n, n\lambda)$. At what sample size do the sampling distribution and superimposed density virtually coincide?
